...
public class GeneralProductAdapter extends RecyclerView.Adapter<GeneralProductAdapter.ViewHolder> {
    ...
    public GeneralProductAdapter(Context context, List<GeneralProduct> generalProductList , RecyclerViewInterface recyclerViewInterface) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.general_row_items, parent, false);
            ...
            itemView.setOnClickListener(view -> {
                if (recyclerViewInterface != null){
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        recyclerViewInterface.onItemClick(position, "Recent", itemView);
                    }
                }
            });
